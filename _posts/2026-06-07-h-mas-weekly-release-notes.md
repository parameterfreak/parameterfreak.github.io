...
| 계획 | 이슈 | 상태 | 비고 |
|------|------|------|------|
| 멀티테넌시 안정화 및 데모 시나리오 검증 | #289 | 부분 달성 | Frontend 마무리(#289) + Popover UX(#314) 완료 |
...
2. **멀티테넌시 Frontend 완성**: Phase 2-4 UI(#289) + Popover 스위처(#314) — 데모 대비 완전한 멀티테넌시 UI 확보
