...
```mermaid
flowchart TD
    S1["**Step 1. 모델 선택**<br/>모델 저장소에서 배포할 모델 선택<br/>모델 크기, 카테고리, 최소 GPU 요구사항 자동 표시"]
...
|------|:---------:|:---------:|:---------:|
| 멀티 클러스터 관리 (Push/Pull) | ✅ | ✅ | ✅ |
| 웹 콘솔 기반 모델 배포 | ✅ | ✅ | ✅ |
| 통합 대시보드 | ✅ | ✅ | ✅ |
| 자동 장애 복구 | ✅ | ✅ | ✅ |
| 로그 조회/이벤트/감사 로그 | ✅ | ✅ | ✅ |
| 실시간 메트릭 모니터링 (GPU, RPS) | — | ✅ | ✅ |
| GP 스케줄링 (QoS, GPU 공유) | — | ✅ | ✅ |
| HP 스케줄링 (토폴로지 인식) | — | ✅ | ✅ |
| 모델 로딩 가속 (분산 캐시) | — | ✅ | ✅ |
| 모델 저장소 (Built-in Registry) | ✅ | ✅ | ✅ |
| 모델 레지스트리 (외부 연동) | — | ✅ | ✅ |
| 기본 인증 (JWT) | ✅ | ✅ | ✅ |
| 인증 고도화 (RBAC, OAuth/OIDC) | — | ✅ | ✅ |
| 프로덕션 안정화 | — | — | ✅ |
| 운영 도구 (알림, 헬스체크 자동화) | — | — | ✅ |
