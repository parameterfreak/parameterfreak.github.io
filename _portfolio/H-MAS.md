...
excerpt: "고비용의 AI 추론 비용을 절감하는 하드웨어 인지형 멀티 클러스터 서빙 플랫폼"
collection: portfolio
header:
  teaser: portfolio/hmas/01-dashboard.png
---
...
<p align="center">
  ...
  <br/>
  <em>[그림 1] H-MAS 대시보드 — 클러스터 상태, GPU 토폴로지, 인스턴스 현황을 한눈에 확인</em>
</p>
...
<p align="center">
  ...
  <br/>
  <em>[그림 2] H-MAS 전체 아키텍처 — 컨트롤 플레인이 HP/GP/Standard 클러스터를 통합 관리</em>
</p>
...
<p align="center">
  ...
  <br/>
  <em>[그림 3] 대시보드 — 통계 카드, 인스턴스 상태 차트, GPU 토폴로지, 최근 활동을 한 화면에서 확인</em>
</p>
...
<p align="center">
  ...
  <br/>
  <em>[그림 4] 클러스터 관리 — GPU 타입별 분류, 클러스터별 GPU 사용량과 스케줄러 정보 확인</em>
</p>
...
<p align="center">
  ...
  <br/>
  <em>[그림 5] GPU 토폴로지 — 노드별 NUMA 구조와 GPU 배치, NVLink/PCIe 인터커넥트 연결 시각화</em>
</p>
...
<p align="center">
  ...
  <br/>
  <em>[그림 6] 모델 배포 — 모델 선택, 서빙 런타임, 배치 전략을 한 화면에서 설정하는 배포 폼</em>
</p>
...
<p align="center">
  ...
  <br/>
  <em>[그림 7] 인스턴스 목록 — 상태, 런타임, 클러스터별 필터링과 검색</em>
</p>
...
<p align="center">
  ...
  <br/>
  <em>[그림 8] 인스턴스 상세 — 외부 엔드포인트, 리소스 현황, 런타임 설정을 한눈에 확인</em>
</p>
...
<p align="center">
  ...
  <br/>
  <em>[그림 9] 모니터링 — GPU 사용량, 메모리, RPS, 지연시간 차트와 실시간 로그 스트리밍</em>
</p>
...
| 버전 | 날짜 | 요약 | 릴리즈 노트 |
|------|------|------|------------|
| v0.4.0 (DP) | 2026-04-05 | 멀티 클러스터 관리, 웹 콘솔, JWT 인증, 원커맨드 설치 | [릴리즈 노트](/posts/2026/04/h-mas-v0.4.0-release/) |
...
<p align="center">
  <img src="/images/portfolio/hmas/copyright-2604.png" alt="저작권 등록증" width="500"/>
  <br/>
  <em>저작권 등록증 — H-MAS (에이치마스) v0.4.0</em>
</p>
